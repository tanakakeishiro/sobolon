...
$site_top = "https://sobolon.tanakakeishiro.com/";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "tanakakeishiro349489@gmail.com";
...
$from = "tanaka@sobolon.tanakakeishiro.com";
...
$Referer_check_domain = "sobolon.tanakakeishiro.com";
...
$require = array('お名前', 'メールアドレス', 'お問い合わせ内容', 'プライバシーポリシーに同意する');
